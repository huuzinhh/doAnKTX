...
public class Register extends javax.swing.JFrame {
    ...
    private String selectedUpQueQuan;
    /**
    ...
    public static void main(String args[]) {
        ...
        void AddThongTinSinhVienDangKy(){
            ...
            String sql = "insert into thongtinsinhviendangky (maSV, tenSV, CCCD, gioiTinh, ngaySinh, email, tenDangNhap, soDienThoai, queQuan, maLop, phanQuyen)"
              + "values(?,?,?,?,?,?,?,?,?,?,?)";
            int row=0;
            String sql1 = "insert into thongtintaikhoan (tenDangNhap, matKhau, email) values(?,?,?)";
        try {
            ...
            ps.setString(9, selectedUpQueQuan);
          ...
          if(row>0){
              JOptionPane.showMessageDialog(this, "Đã thêm sinh viên vào danh sách đăng ký");
          } else{
